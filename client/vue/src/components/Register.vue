            ...
            <form class="box">
              ...
              <div class="field">
                ...
                <div class="control has-icons-left">
                  <input class="input" type="text" id="fullName" v-model="fullName" placeholder="e.g. Alex Johnson"
              ...
              <div class="field">
                ...
                <div class="control has-icons-left">
                  <input class="input" type="password" id="passwordConfirm" v-model="confirmPassword"
              ...
              <div id="errorParent" class="notification is-danger" style="display: none;">
